...
public class LDUtil {
    ...
    /**
     * Prints every nth character of a string given the string and the Increment amount.
     * @param input
     * @param nthIncrement
     */
    public static printEveryNthChar(String input, int nthIncrement)
    {
        int count = 0;
        for (char c : input.toCharArray())
        {
            if (count % nthIncrement == 0)
            {
