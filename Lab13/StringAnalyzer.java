public class StringAnalyzer {
    ...
    public char firstRepeatedCharacter(String aString) {
        ...
        for (int i = 0; i < aString.length() - 1; i++) { //added -1 to the length in the conditional portion of the loop PART B
    ...
    public int countRepeatedCharacters(String aString) {
        ...
        for (int i = 0; i < aString.length() - 1; i++) {
            ...
            {
                if (i == 0 ? true : aString.charAt(i - 1) != aString.charAt(i)) // it's the start
                { //I just used the ternary operator to check if our index was the beginning of the string and let the if statement pass.
                    //This prevents the issue were the character at -1 can't be found and is skipped.
                    c++;
                }
            }
        }
